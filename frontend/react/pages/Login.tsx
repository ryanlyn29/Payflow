...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.error?.message || err.message || 'Authentication failed. Please check credentials.';
      ...
      <div className="flex-1 flex flex-col p-6 md:p-10 lg:p-12 relative overflow-y-auto bg-white custom-scrollbar">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-[400px] mx-auto w-full pb-8">
          <div className="mb-6">
            ...
            <p className="text-slate-500 font-medium text-xs">Enter your credentials to access your account</p>
          </div>
          ...
          <p className="mt-6 text-center text-xs font-bold text-slate-500">
            Don't have an account? <Link to="/signup" className="text-blue-600 hover:text-blue-700 transition-colors">Sign up</Link>
          </p>
        </div>
